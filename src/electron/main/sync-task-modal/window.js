...
export function createSyncTaskModalWindow(modalName, context = {}) {
  ...
  ipcMain.handle('sync-task-modal:update-sync-task-ignore-patterns', handlers.updateSyncTaskIgnorePatternsHandler)
  ...
  modalWindow.on('closed', () => {
    ...
    ipcMain.removeHandler('sync-task-modal:update-sync-task-ignore-patterns')
