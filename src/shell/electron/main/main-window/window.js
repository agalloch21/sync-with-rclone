...
export function createMainWindow() {
  ...
  ipcMain.handle('main-window:get-global-exclusion-patterns', handlers.getGlobalExclusionPatternsHandler)
  ...
  ipcMain.handle('main-window:update-global-exclusion-patterns', handlers.updateGlobalExclusionPatternsHandler)
  ...
  mainWindow.on('closed', () => {
    ...
    ipcMain.removeHandler('main-window:get-global-exclusion-patterns')
    ...
    ipcMain.removeHandler('main-window:update-global-exclusion-patterns')
