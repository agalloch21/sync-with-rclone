const mainWindow = {
  ...
  logPanel: {
    ...
    operations: {
      ...
      updateMappingFilterPatterns: 'Update mapping sync filters',
      deleteMapping: 'Delete mapping',
      updateGlobalFilterPatterns: 'Update global sync filters',
      syncPush: 'Push files',
      syncPull: 'Pull files',
      sync: 'Sync files',
    },
