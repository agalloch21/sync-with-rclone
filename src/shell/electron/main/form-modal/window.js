...
export function createFormModalWindow(view, context = {}) {
  ...
  ipcMain.handle('form-modal:update-mapping-ignore-patterns', handlers.updateMappingIgnorePatternsHandler)
  ...
  modalWindow.on('closed', () => {
    ...
    ipcMain.removeHandler('form-modal:update-mapping-ignore-patterns')
