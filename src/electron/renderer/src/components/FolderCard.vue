...
<template>
  <div class="bg-white rounded-2xl border border-[#81B5F630] drop-shadow-[0_1px_2px_rgba(0,0,0,0.05)] flex flex-col py-1.5 px-4 relative">
    <div class="shrink-0 text-[0.625rem] leading-4 font-extralight tracking-[0.15rem] text-[#26619D] overflow-hidden text-ellipsis whitespace-nowrap ">
      {{ props.title }}
    </div>
    <div class="shrink-0 text-base leading-6 font-bold text-[#00345E] overflow-hidden text-ellipsis whitespace-nowrap ">
      {{ props.hero }}
    </div>
    <div
      ref="contentRef"
      class="flex-1 text-[0.625rem] leading-4 font-normal text-[#254CE4] break-all min-h-0 overflow-hidden [display:-webkit-box] [-webkit-box-orient:vertical]"
