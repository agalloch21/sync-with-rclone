...
export function createFormModalWindow(view, context = {}) {
  ...
  ipcMain.handle('form-modal:get-global-filter-patterns', handlers.getGlobalFilterPatternsHandler)
  ...
  ipcMain.handle('form-modal:update-mapping-filter-patterns', handlers.updateMappingFilterPatternsHandler)
  ...
  modalWindow.on('closed', () => {
    ...
    ipcMain.removeHandler('form-modal:get-global-filter-patterns')
    ...
    ipcMain.removeHandler('form-modal:update-mapping-filter-patterns')
