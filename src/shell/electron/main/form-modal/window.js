...
export function createFormModalWindow(view, context = {}) {
  ...
  ipcMain.handle('form-modal:create-sync-task', handlers.createSyncTaskHandler)
  ipcMain.handle('form-modal:update-sync-task', handlers.updateSyncTaskHandler)
  ipcMain.handle('form-modal:update-sync-task-ignore-patterns', handlers.updateSyncTaskIgnorePatternsHandler)
  ...
  modalWindow.on('closed', () => {
    ...
    ipcMain.removeHandler('form-modal:create-sync-task')
    ipcMain.removeHandler('form-modal:update-sync-task')
    ipcMain.removeHandler('form-modal:update-sync-task-ignore-patterns')
