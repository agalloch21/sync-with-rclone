...
const stage = computed(() => state.value?.sessionState?.stage || '')
const phase = computed(() => state.value?.sessionState?.phase || '')
const mode = computed(() => state.value?.sessionState?.context?.mode || '')
